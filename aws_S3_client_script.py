...
def main():
    ...
    while True:
        ...
        if aws_profile != '':
            ...
            ec2_client = boto3.client('ec2', **config_dict)
            break

    all_bucket_names = [bucket.name for bucket in s3_resource.buckets.all()]
    ...
    user_name = get_valid_user_name('User name: ', all_user_names)
